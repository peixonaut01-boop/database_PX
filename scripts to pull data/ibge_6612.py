"""
Script to fetch IBGE Table 6612: Valores encadeados a preços de 1995
"""
from ibge_base import fetch_ibge_data, clean_and_structure_data, upload_table_data

# --- Configuration ---

# IBGE URL for the XLSX data (Table 6612)
IBGE_URL = 'https://sidra.ibge.gov.br/geratabela?format=xlsx&name=tabela6612.xlsx&terr=N&rank=-&query=t/6612/n1/all/v/all/p/all/c11255/all/d/v9318%202/l/v,c11255,t%2Bp'

# Table configuration
TABLE_NUMBER = 6612
TABLE_NAME = 'Valores encadeados a preços de 1995 (nº6612)'
...
def fetch_and_upload_ibge_data():
    ...
    """
    print("1. Fetching data from IBGE (Table 6612)...")
    try:
