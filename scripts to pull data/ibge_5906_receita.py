"""
Script to fetch IBGE Table 5906 - Subbranch 1: Receita (Revenue)
...
# IBGE URL for the XLSX data (Table 5906 - Receita)
IBGE_URL = 'https://sidra.ibge.gov.br/geratabela?format=xlsx&name=tabela5906.xlsx&terr=N&rank=-&query=t/5906/n1/all/v/all/p/all/c11046/56725/d/v7167%205,v7168%205,v11623%201,v11624%201,v11625%201,v11626%201/l/v,c11046,t%2Bp'

# Table configuration
TABLE_NUMBER = 5906
TABLE_NAME = 'PMS - Índice e variação da receita nominal e do volume de serviços (2022 = 100) - Receita (nº5906)'
...
def fetch_and_upload_ibge_data():
    ...
    """
    print("1. Fetching data from IBGE (Table 5906 - Receita)...")
    try:
