"""
Script to fetch IBGE Table 2072: Contas econômicas trimestrais
This table has 12 sheets - each sheet will be uploaded as a separate Firebase node
"""
...
# IBGE URL for the XLSX data (Table 2072)
IBGE_URL = 'https://sidra.ibge.gov.br/geratabela?format=xlsx&name=tabela2072.xlsx&terr=N&rank=-&query=t/2072/n1/all/v/all/p/all/l/v,,t%2Bp'

# Table configuration
TABLE_NUMBER = 2072
TABLE_NAME = 'Contas econômicas trimestrais (nº2072)'
PERIOD_RANGE = '1º trimestre 2000 a 2º trimestre 2025'
...
def fetch_and_upload_ibge_data():
    ...
    """
    print("1. Fetching data from IBGE (Table 2072)...")
    try:
        # Fetch all sheets
